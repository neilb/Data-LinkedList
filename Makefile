# This Makefile is for the Data::LinkedList extension to perl.
#
...
#     ABSTRACT => q[Perl implementation of the GNU Classpath LinkedList.]
#     AUTHOR => [q[Lloyd Griffiths (lloydg@cpan.org)]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     META_MERGE => { resources=>{ repository=>q[https://github.com/LloydGriffiths/Data-LinkedList] } }
#     NAME => q[Data::LinkedList]
#     PREREQ_PM => { Iterator::Util=>q[0.02], Storable=>q[2.34], Test::Simple=>q[0.44] }
#     VERSION_FROM => q[lib/Data/LinkedList.pm]
...
TO_INST_PM = lib/Data/LinkedList.pm \
	lib/Data/LinkedList/Entry.pm \
	lib/Data/LinkedList/Iterator/DescendingIterator.pm \
	lib/Data/LinkedList/Iterator/ListIterator.pm

PM_TO_BLIB = lib/Data/LinkedList/Entry.pm \
	blib\lib\Data\LinkedList\Entry.pm \
	lib/Data/LinkedList/Iterator/ListIterator.pm \
	blib\lib\Data\LinkedList\Iterator\ListIterator.pm \
	lib/Data/LinkedList/Iterator/DescendingIterator.pm \
	blib\lib\Data\LinkedList\Iterator\DescendingIterator.pm \
	lib/Data/LinkedList.pm \
	blib\lib\Data\LinkedList.pm
...
DISTNAME = Data-LinkedList
DISTVNAME = Data-LinkedList-0.1
...
LinkedList.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Data::LinkedList\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: 'Perl implementation of the GNU Classpath LinkedList.'" >> META_new.yml
	$(NOECHO) $(ECHO) author: >> META_new.yml
	$(NOECHO) $(ECHO) "  - 'Lloyd Griffiths (lloydg@cpan.org)'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: Data-LinkedList" >> META_new.yml
	$(NOECHO) $(ECHO) no_index: >> META_new.yml
	$(NOECHO) $(ECHO) "  directory:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - t" >> META_new.yml
	$(NOECHO) $(ECHO) "    - inc" >> META_new.yml
	$(NOECHO) $(ECHO) requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  Iterator::Util: 0.02" >> META_new.yml
	$(NOECHO) $(ECHO) "  Storable: 2.34" >> META_new.yml
	$(NOECHO) $(ECHO) "  Test::Simple: 0.44" >> META_new.yml
	$(NOECHO) $(ECHO) resources: >> META_new.yml
	$(NOECHO) $(ECHO) "  repository: https://github.com/LloydGriffiths/Data-LinkedList" >> META_new.yml
	$(NOECHO) $(ECHO) "version: 0.1" >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) {{ > META_new.json
	$(NOECHO) $(ECHO) "   \"abstract\" : \"Perl implementation of the GNU Classpath LinkedList.\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"author\" : [" >> META_new.json
	$(NOECHO) $(ECHO) "      \"Lloyd Griffiths (lloydg^@cpan.org)\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Data-LinkedList\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"requires\" : {{" >> META_new.json
	$(NOECHO) $(ECHO) "            \"Iterator::Util\" : \"0.02\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Storable\" : \"2.34\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"url\" : \"https://github.com/LloydGriffiths/Data-LinkedList\"" >> META_new.json
	$(NOECHO) $(ECHO) "      }}" >> META_new.json
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Perl implementation of the GNU Classpath LinkedList.</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Lloyd Griffiths (lloydg@cpan.org)</AUTHOR>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Iterator::Util\" VERSION=\"0.02\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Storable::\" VERSION=\"2.34\" />" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Data/LinkedList/Entry.pm blib\lib\Data\LinkedList\Entry.pm \
	  lib/Data/LinkedList/Iterator/ListIterator.pm blib\lib\Data\LinkedList\Iterator\ListIterator.pm \
	  lib/Data/LinkedList/Iterator/DescendingIterator.pm blib\lib\Data\LinkedList\Iterator\DescendingIterator.pm \
	  lib/Data/LinkedList.pm blib\lib\Data\LinkedList.pm 
